      ...
      <div class="row">
        ...
        <?php if(isset($params[1]) && $params[1]=="page") {
              $count = getBlogCount();
              if($params[2]>ceil($count/3) && $params[2]>1) header("Location: /blog/page/".max(ceil($count/3),1));
          ...
          if(isset($params[1]) && $params[1]=="company") {
              ...
              if($params[3]>ceil($count/3) && $params[3]>1) header("Location: /blog/company/".$params[2].'/'.max(ceil($count/3),1));
              $page=$params[3];
          ...
          if(isset($params[1]) && $params[1]=="user") {
            ...
            if($params[3]>ceil($count/3) && $params[3]>1) header("Location: /blog/user/".$params[2].'/'.max(ceil($count/3),1));
            $page=$params[3];
