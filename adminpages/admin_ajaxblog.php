<?php 
	if($params[3] == "approve") {
		...
		$message="<p>Hello ".$user['fname'].",</p><p>Your Blog titled ".$blog['title']." has been approved</p><br /><br /><p>View it at</p><p><a href='".$_SERVER['SERVER_NAME']."/experiences/article/".$blog['slug']."'>".$_SERVER['SERVER_NAME']."/experiences/article/".$blog['slug']."</a></p>";
